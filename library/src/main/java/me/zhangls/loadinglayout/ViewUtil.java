...
public class ViewUtil {
    ...
    static WeakHashMap<View, List<ViewTreeObserver.OnGlobalLayoutListener>> sViewTreeObserverListenerMap
            = new WeakHashMap<View, List<ViewTreeObserver.OnGlobalLayoutListener>>();
     ...
     */
    public static void addGlobalLayoutListenerOnce(final View view, final
                    ...
                    final OnGlobalLayoutListenerQueueExecutor tempListener = new OnGlobalLayoutListenerQueueExecutor() {
                        ...
                        public void onGlobalLayout() {
                            ...
                            if (isCachedViewTreeObserver(view)) {
                                //ToDo thread safe
                                try {
                                    for (ViewTreeObserver.OnGlobalLayoutListener entry
                                            : sViewTreeObserverListenerMap.get(view)) {
                                        if (entry != null) {
